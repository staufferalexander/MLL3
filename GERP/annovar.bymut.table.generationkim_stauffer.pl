...
#print Dumper \@sample;
my %mut;
my $mut_file = "/scratch/stauffkm/vcf/BRCA1.hg19_multianno.txt"; 
...
my $out_file = "/scratch/stauffkm/vcf/BRCA1.hg19_annovartable.txt"; ####REPLACE THIS WITH A NEW OUTFILE NAME
